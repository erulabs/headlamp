...
export const trackEventAction = createAction<HeadlampEvent>('headlamp/trackEvent');

export const listenerMiddleware = createListenerMiddleware();
listenerMiddleware.startListening({
  actionCreator: trackEventAction,
...
export function useTrackEvent(): (eventInfo: HeadlampEvent | HeadlampEvent['type']) => void;
export function useTrackEvent(eventType: HeadlampEventType.ERROR_BOUNDARY): (error: Error) => void;
...
export function useTrackEvent(eventType?: HeadlampEventType | string) {
  const dispatch = useDispatch();

  function trackDataEventFunc<T extends HeadlampEvent>(eventType: HeadlampEventType) {
  ...
  switch (eventType) {
    ...
    case HeadlampEventType.DELETE_RESOURCE:
      return trackDataEventFunc<DeleteResourceEvent>(HeadlampEventType.DELETE_RESOURCE);
    case HeadlampEventType.EDIT_RESOURCE:
      return trackDataEventFunc<EditResourceEvent>(HeadlampEventType.EDIT_RESOURCE);
    case HeadlampEventType.SCALE_RESOURCE:
      return trackDataEventFunc<ScaleResourceEvent>(HeadlampEventType.SCALE_RESOURCE);
    case HeadlampEventType.RESTART_RESOURCE:
      return trackDataEventFunc<RestartResourceEvent>(HeadlampEventType.RESTART_RESOURCE);
    case HeadlampEventType.LOGS:
      return trackDataEventFunc<LogsEvent>(HeadlampEventType.LOGS);
    case HeadlampEventType.TERMINAL:
      return trackDataEventFunc<TerminalEvent>(HeadlampEventType.TERMINAL);
    case HeadlampEventType.POD_ATTACH:
      return trackDataEventFunc<PodAttachEvent>(HeadlampEventType.POD_ATTACH);
    case HeadlampEventType.CREATE_RESOURCE:
      return trackDataEventFunc<CreateResourceEvent>(HeadlampEventType.CREATE_RESOURCE);
    ...
    case HeadlampEventType.DETAILS_VIEW:
      return trackDataEventFunc<ResourceDetailsViewLoadedEvent>(HeadlampEventType.DETAILS_VIEW);
    case HeadlampEventType.LIST_VIEW:
      return trackDataEventFunc<ResourceListViewLoadedEvent>(HeadlampEventType.LIST_VIEW);
